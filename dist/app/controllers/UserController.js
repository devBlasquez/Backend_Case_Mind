...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, userExists, _a, id, name, email;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a = _b.sent(), id = _a.id, name = _a.name, email = _a.email;
    ...
    UserController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, _a, email, oldPassword, user, userExists, _b, _c, id, name;
                ...
                switch (_d.label) {
                    case 0:
                        schema = Yup.object().shape({
                            ...
                            password: Yup.string()
                                .min(6)
                                .when("oldPassword", function (oldPassword, field) {
                    ...
                    case 1:
                        if (!(_d.sent()))
                            return [2 /*return*/, res.status(400).json({ error: "Validation fails" })];
                        _a = req.body, email = _a.email, oldPassword = _a.oldPassword;
                    ...
                    case 6:
                        if (_b)
                            return [2 /*return*/, res.status(400).json({ error: "Password does not match." })];
                        return [4 /*yield*/, user.update(req.body)];
                    case 7:
                        _c = _d.sent(), id = _c.id, name = _c.name;
                        return [2 /*return*/, res.json({ id: id, name: name, email: email })];
                }
            });
        });
